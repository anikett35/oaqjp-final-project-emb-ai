...
An AI-powered web application that detects emotions in text using IBM Watson NLP library and Flask.

## Overview
This application takes text input from a user, analyzes the emotion conveyed (anger, disgust, fear, joy, sadness), and returns the emotion scores along with the dominant emotion.

## Project Structure
- `EmotionDetection/`: Python package containing emotion detection logic.
  - `__init__.py`: Package initializer.
  - `emotion_detection.py`: Contains `emotion_detector` interacting with Watson NLP EmotionPredict service.
